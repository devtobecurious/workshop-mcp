...
var response = await chatClient.GetResponseAsync(messages, new() { Tools = [.. tools.Cast<AITool>()] });
...
if (functionCalls.Any())
{
    ...
    response = await chatClient.GetResponseAsync(messages, new() { Tools = [.. tools.Cast<AITool>()] });
}
